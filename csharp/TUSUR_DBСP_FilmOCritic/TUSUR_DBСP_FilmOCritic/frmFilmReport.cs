...
{
    public partial class frmFilmReport : Form
    {
        public frmFilmReport()
        {
            InitializeComponent();
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            app.Visible = false;
            app.DoCmd.OpenReport("repFilm", Microsoft.Office.Interop.Access.AcView.acViewPreview, System.Reflection.Missing.Value, "(([last_update] Between #" + date.Value.ToShortDateString() + "# And #" + date.Value.ToShortDateString() + " 23:59:00#) AND ([admin_id] = " + Program.user_id + "))"); //Type.Missing, objAccApp.AcWindowMode.acWindowNormal, Type.Missing);
